...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('promotion')->insert([
            ['promo_Id'=>1, 'coupon_Id'=>1 ,'name'=>'Apple iPhone 13 Pro', 'date_Start'=> date("Y-m-d H:i:s"), 'date_end'=> '2022/11/05', 'price'=>220.15,'discountPerc'=>50 ,'image'=>'Iphone.jpg','desc' => self::DESCPROD],
            ['promo_Id'=>2, 'coupon_Id'=>2 ,'name'=>'APPLE iPad Pro 11" Chip M2', 'date_Start'=> date("Y-m-d H:i:s"), 'date_end'=> '2020/10/05' ,'price'=>1299.99,'discountPerc'=>20,'image'=>'Ipad.jpg','desc' => self::DESCPROD ],
            ['promo_Id'=>3, 'coupon_Id'=>3 ,'name'=>'Apple MacBook Pro 13" M2','date_Start'=> date("Y-m-d H:i:s"), 'date_end'=> '2023/01/10' , 'price'=>159.00,'discountPerc'=>10 ,'image'=>'Mac.jpg','desc' => self::DESCPROD],
            ['promo_Id'=>4, 'coupon_Id'=>4 ,'name'=>'Nike Air Jordan 1 Retro Chicago (2015)', 'date_Start'=> date("Y-m-d H:i:s"), 'date_end'=> '2022/03/20' ,'price'=>520.15 ,'discountPerc'=>60,'image'=>'Nike1.jpg','desc' => self::DESCPROD],
            ['promo_Id'=>5, 'coupon_Id'=>5 ,'name'=>'Nike Dunk Low Off-White University Red', 'date_Start'=> date("Y-m-d H:i:s"), 'date_end'=> '2023/01/05', 'price'=>399.99,'discountPerc'=>30 ,'image'=>'Nike2.jpg','desc' => self::DESCPROD],
            ['promo_Id'=>6, 'coupon_Id'=>6 ,'name'=>'Appartamento Milano AirBnb', 'date_Start'=> date("Y-m-d H:i:s"), 'date_end'=> '2020/11/17' , 'price'=>90.00 ,'discountPerc'=>15,'image'=>'Appartamento.jpg','desc' => self::DESCPROD],
            ['promo_Id'=>7, 'coupon_Id'=>7 ,'name'=>'Bracciale Bead Heart Tag Tiffany' ,'date_Start'=> date("Y-m-d H:i:s"), 'date_end'=> '2022/05/03' , 'price'=>700.00 ,'discountPerc'=>15,'image'=>'Collana.jpg','desc' => self::DESCPROD],
            ['promo_Id'=>8, 'coupon_Id'=>8,'name'=>'CHANEL-N°5','date_Start'=> date("Y-m-d H:i:s"), 'date_end'=> '2020/01/01' , 'price'=>100.00 ,'discountPerc'=>15,'image'=>'Chanel1.jpg','desc' => self::DESCPROD],
            ['promo_Id'=>9, 'coupon_Id'=>9,'name'=>'Abbonamento 6 mesi Spotify Premium', 'date_Start'=> date("Y-m-d H:i:s"), 'date_end'=> '2022/09/23' , 'price'=>50.00 ,'discountPerc'=>15,'image'=>'Spotify1.jpg','desc' => self::DESCPROD],
        ]);
